...
/*
 * DAO layer for interacting with database, specifically for account table and model class.
 */
public class AccountDAO {

    /**
     * The account_id should be automatically generated by the sql database if it is not provided because it was
     * set to auto_increment. Therefore, we only need to insert a record with username and password.
     * @param account the account object to be inserted into the table.
    ...
    /**
     * Retrieve an account from the account table, identified by its id.
     * @param id int id for account.
